...
class CloudCompare(PointCloudProcessor):
    ...
    def __init__(self, path_cloud_compare: str):
        """
    ...
    def mise_a_echelle(self, point_cloud: PointCloud, facteur: float) -> PointCloud:
        ...
        subprocess.run([self.path_cloud_compare, "-SILENT", "-C_EXPORT_FMT", f"{point_cloud.extension.upper()}",
